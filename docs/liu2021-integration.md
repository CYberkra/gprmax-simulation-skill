...
论文流程从 [SKILL.md](../SKILL.md) 和 [联合仿真参考](../references/liu2021-joint-chain.md) 进入；实际合成使用 [MATLAB 模块](../assets/liu2021/sfcw_paper_H_fixed.m)，调用与环境选择见 [工具入口](../references/tooling.md)。模块增加了输入和窗口检查，计算内核保持不变。旧 CLI 的 impulse_lti、broadband_deconvolution 等模式不因文档更新而自动成为 Liu2021 修正链。
